...
class BaseModel:
    ...
    def print_networks(self):
        ...
        for net in self.networks.values():
            ...
            pytorch_total_params = sum(p.numel() for p in bare_net.parameters() if p.requires_grad)
            logger.info(f'Network: {net_cls_str}, withl learning parameters: {pytorch_total_params:,d}')
